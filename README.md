...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/7-10-task-add-features-to-expense-tracker-application">Assignment 7 - Add features to Expense Tracker Application</a></h3>
</p>
...
2. Clone this repository -
    ```sh
    git clone https://github.com/Learn-with-Sumit/assignment-7---add-features-to-expense-tracker-application-programmertowheed.git
    ```
3. Go to the cloned project directory
    ```sh
    cd assignment-7---add-features-to-expense-tracker-application-programmertowheed
    ```
